...
function getScoreGradient(score: number) {
  if (score >= 80) return { from: "#009E5C", to: "#48D08C" }
  if (score >= 60) return { from: "#305EFF", to: "#75A3FF" }
  if (score >= 40) return { from: "#E67E22", to: "#F39C12" }
  return { from: "#D32F2F", to: "#EF5350" }
}
...
const statusColor = {
  excellent: { text: "text-[#009E5C]", bg: "bg-[#009E5C]/10", fill: "#009E5C" },
  good: { text: "text-[#305EFF]", bg: "bg-[#305EFF]/10", fill: "#305EFF" },
  fair: { text: "text-[#D97706]", bg: "bg-[#D97706]/10", fill: "#D97706" },
  poor: { text: "text-[#D32F2F]", bg: "bg-[#D32F2F]/10", fill: "#D32F2F" },
}
