  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Theme and visual styling for Razorpay Blade Design System
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="flex flex-col gap-2 rounded-lg border-2 border-primary bg-surface-1 p-5 ring-2 ring-primary/20">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <SunIcon className="size-5 text-primary" />
                <span className="text-sm font-semibold text-text-primary">Razorpay Light (Blade)</span>
              </div>
              <CheckIcon className="size-4 text-primary" />
            </div>
            <p className="text-xs text-text-muted">
              Official light theme with Blade tokens (#305EFF primary, #009E5C success, crisp contrast).
            </p>
            <div className="mt-2 flex gap-2">
              <span className="h-4 w-8 rounded bg-[#305EFF]" title="Primary #305EFF" />
              <span className="h-4 w-8 rounded bg-[#4D7FFF]" title="Primary Light #4D7FFF" />
              <span className="h-4 w-8 rounded bg-[#009E5C]" title="Success #009E5C" />
              <span className="h-4 w-8 rounded bg-[#E6EFF4]" title="Surface 2 #E6EFF4" />
            </div>
          </div>
        </div>
      </CardContent>
