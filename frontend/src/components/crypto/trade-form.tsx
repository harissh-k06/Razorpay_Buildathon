        ...
        <AnimatePresence mode="wait">
          {success ? (
            <motion.div
              ...
              className="flex flex-col items-center gap-1 rounded-lg bg-[#009E5C]/10 py-3 text-center"
            >
              <CheckCircleIcon className="size-6 text-[#009E5C]" />
              <p className="text-sm font-semibold text-success">Trade completed!</p>
              {successDetail && (
