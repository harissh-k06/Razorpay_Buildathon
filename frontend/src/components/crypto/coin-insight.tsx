      ...
      <CardContent className="min-w-0 space-y-4">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <ChartContainer
              config={chartConfig}
              className="aspect-auto h-[340px] w-full [&_.recharts-rectangle.recharts-tooltip-cursor]:fill-zinc-950/5 [&_.recharts-cartesian-grid_line[stroke='#ccc']]:stroke-border/64 [&_.recharts-cartesian-axis-line]:stroke-border/64 [&_.recharts-cartesian-axis-tick_text]:fill-muted-foreground/72"
            >
