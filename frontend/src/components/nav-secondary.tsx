...
const typeColor: Record<string, string> = {
  transaction: "bg-[#009E5C]/10 text-[#009E5C]",
  security: "bg-rose-100 text-rose-700",
  system: "bg-amber-100 text-amber-700",
  promotion: "bg-[#75A3FF]/15 text-[#2950DA]",
  request: "bg-[#305EFF]/10 text-[#305EFF]",
}
                ...
                <div className="min-w-0 flex-1">
                  ...
                  {n.actionable && (
                    <div className="mt-2">
                      ...
                      {state === "accepted" && (
                        <div className="flex items-center gap-1.5 py-1 text-[11px] font-medium text-success">
